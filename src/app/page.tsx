    ...
    <main className="min-h-screen bg-white">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
          ...
          <div className="flex gap-3">
            ...
            <button
              ...
              className="px-6 py-2 bg-emerald-600 text-white rounded-full hover:bg-emerald-700 font-medium transition-colors"
            >
              Get Started
            </button>
          </div>
      ...
      <section className="pt-32 pb-20 px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <button
            onClick={() => scrollToSection('features')}
            className="inline-block px-8 py-4 bg-emerald-600 text-white text-lg font-semibold rounded-full hover:bg-emerald-700 transition-colors"
          >
      ...
      <section id="cta" className="py-20 px-4">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <div className="flex gap-4 justify-center flex-wrap">
            <button className="px-8 py-4 bg-emerald-600 text-white text-lg font-semibold rounded-full hover:bg-emerald-700 transition-colors">
              Start Free Today
            </button>
            <button 
              onClick={() => scrollToSection('features')}
              className="px-8 py-4 border-2 border-gray-300 text-gray-900 text-lg font-semibold rounded-full hover:border-emerald-600 hover:text-emerald-600 transition-colors"
            >
              Learn More
            </button>
          </div>
