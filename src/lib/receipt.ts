...
export function generateReceiptHTML(data: ReceiptData): string {
  const { receiptNumber, generatedAt, expense, user } = data;
...
<head>
  ...
  <style>
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    .detail-value { font-size: 13px; color: #1e293b; font-weight: 600; text-align: right; }
...
<body>
  ...
  <div class="receipt">
    <div class="receipt-header">
      <div>
        <div class="logo">Ledger<span class="logo-dot">.</span></div>
    ...
    <div class="receipt-footer">
      <span>Generated by Ledger &bull; ${new Date(generatedAt).getFullYear()}</span>
